...
public class MantraAdapter extends RecyclerView.Adapter<MantraAdapter.MyView> {
    ...
    @Override
    public MantraAdapter.MyView onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.mantra_list_item, parent, false);

        return new MantraAdapter.MyView(itemView);
    }

    @Override
    public void onBindViewHolder(final MantraAdapter.MyView holder, final int position) {
