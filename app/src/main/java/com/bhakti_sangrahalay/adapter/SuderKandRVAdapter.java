...
public class SuderKandRVAdapter extends RecyclerView.Adapter<SuderKandRVAdapter.MyView> {
    ...
    @Override
    public SuderKandRVAdapter.MyView onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.sunder_kand_list_item, parent, false);

        return new SuderKandRVAdapter.MyView(itemView);
    }

    @Override
    public void onBindViewHolder(final SuderKandRVAdapter.MyView holder, final int position) {
