...
public class SuderKandRVAdapter1 extends RecyclerView.Adapter<SuderKandRVAdapter1.MyView> {
    ...
    @Override
    public SuderKandRVAdapter1.MyView onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.sunder_kand_list_item, parent, false);

        return new SuderKandRVAdapter1.MyView(itemView);
    }

    @Override
    public void onBindViewHolder(final SuderKandRVAdapter1.MyView holder, final int position) {
